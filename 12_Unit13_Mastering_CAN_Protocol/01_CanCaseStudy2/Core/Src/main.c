...
//STD_ID
//Data Frame
void CAN_TX(uint32_t ID , uint8_t DLC , uint8_t *Payload , uint8_t pollingEn)
{
...
//STD_ID
//Data Frame
void CAN_RX(uint32_t* ID , uint8_t* DLC , uint8_t *Payload, uint8_t pollingEn)
{
...
int main(void)
{
	...
	while (1)
	{
		...
		TX_DATA[0] ^=1; // to toggle between ACC & NOACC
		/* USER CODE END WHILE */
