...
Startup/%.o: ../Startup/%.s Startup/subdir.mk
	arm-none-eabi-gcc -mcpu=cortex-m3 -g3 -DDEBUG -c -I"D:/Embedded System Diploma/Mastring Embedded System With K.S/01_StmCube_Workspace/10_U14L4A1/Src/UTILS/inc" -I"D:/Embedded System Diploma/Mastring Embedded System With K.S/01_StmCube_Workspace/10_U14L4A1/Src/MCAL/inc" -gdwarf-2 -x assembler-with-cpp -MMD -MP -MF"$(@:%.o=%.d)" -MT"$@" --specs=nano.specs -mfloat-abi=soft -mthumb -o "$@" "$<"
