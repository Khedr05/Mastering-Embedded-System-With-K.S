...
/*=============================================================================================
* @Function Name : MRCC_u16GetPrescalerVal
...
COMMON_uddtApiState_t MRCC_uddtResetPeripheral(MRCC_uddtPeripheral_t uddtPeripheral)
{
	...
	{
		switch (uddtPeripheral) {
		case MRCC_AFIO: 	RCC->APB2RSTR |=(1<<0);	break;
		case MRCC_IOPA: 	RCC->APB2RSTR |=(1<<2);	break;
		case MRCC_IOPB:		RCC->APB2RSTR |=(1<<3);	break;
		case MRCC_IOPC: 	RCC->APB2RSTR |=(1<<4);	break;
		case MRCC_IOPD: 	RCC->APB2RSTR |=(1<<5);	break;
		case MRCC_IOPE:		RCC->APB2RSTR |=(1<<6);	break;
		case MRCC_IOPF:		RCC->APB2RSTR |=(1<<7);	break;
		case MRCC_IOPG:		RCC->APB2RSTR |=(1<<8);	break;
		case MRCC_ADC1:		RCC->APB2RSTR |=(1<<9);	break;
		case MRCC_ADC2:		RCC->APB2RSTR |=(1<<10);break;
		case MRCC_TIM1:		RCC->APB2RSTR |=(1<<11);break;
		case MRCC_SPI1:		RCC->APB2RSTR |=(1<<12);break;
		case MRCC_TIM8:		RCC->APB2RSTR |=(1<<13);break;
		case MRCC_USART1:	RCC->APB2RSTR |=(1<<14);break;
		case MRCC_ADC3:		RCC->APB2RSTR |=(1<<15);break;
		case MRCC_TIM9:		RCC->APB2RSTR |=(1<<19);break;
		case MRCC_TIM10:	RCC->APB2RSTR |=(1<<20);break;
		case MRCC_TIM11:	RCC->APB2RSTR |=(1<<21);break;
		case MRCC_TIM2:		RCC->APB1RSTR |=(1<<0);	break;
		case MRCC_TIM3:		RCC->APB1RSTR |=(1<<1);	break;
		case MRCC_TIM4:		RCC->APB1RSTR |=(1<<2);	break;
		case MRCC_TIM5:		RCC->APB1RSTR |=(1<<3);	break;
		case MRCC_TIM6:		RCC->APB1RSTR |=(1<<4);	break;
		case MRCC_TIM7:		RCC->APB1RSTR |=(1<<5);	break;
		case MRCC_TIM12:	RCC->APB1RSTR |=(1<<6);	break;
		case MRCC_TIM13:	RCC->APB1RSTR |=(1<<7);	break;
		case MRCC_TIM14:	RCC->APB1RSTR |=(1<<8);	break;
		case MRCC_WWDG:		RCC->APB1RSTR |=(1<<11);break;
		case MRCC_SPI2:		RCC->APB1RSTR |=(1<<14);break;
		case MRCC_SPI3:		RCC->APB1RSTR |=(1<<15);break;
		case MRCC_USART2:	RCC->APB1RSTR |=(1<<17);break;
		case MRCC_USART3:	RCC->APB1RSTR |=(1<<18);break;
		case MRCC_USART4:	RCC->APB1RSTR |=(1<<19);break;
		case MRCC_USART5:	RCC->APB1RSTR |=(1<<20);break;
		case MRCC_I2C1:		RCC->APB1RSTR |=(1<<21);break;
		case MRCC_I2C2:		RCC->APB1RSTR |=(1<<22);break;
		case MRCC_USB:		RCC->APB1RSTR |=(1<<23);break;
		case MRCC_CAN:		RCC->APB1RSTR |=(1<<25);break;
		case MRCC_BKP:		RCC->APB1RSTR |=(1<<27);break;
		case MRCC_PWR:		RCC->APB1RSTR |=(1<<28);break;
		case MRCC_DAC:		RCC->APB1RSTR |=(1<<29);break;
		default: 			ret =UAPI_INVALID_PARM; break;
		}
	}
	else
